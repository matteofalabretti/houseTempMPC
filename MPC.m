function controlAction = MPC(x_attuale, sys, Q, R, Window, Hx, hx, Vinc_X, Vinc_U)

[A_cal , A_cal_n , B_cal , B_cal_n,  Q_cal , R_cal , G_cal , g_cal] = Calligrafica(sys.A , sys.B , Q , R , Q , Window , Hx , hx);
...
A_qp = [B_cal; %vincolo di massimo dello stato
        ...
        Hx * B_cal_n]; % Spero che sia questo il vincolo
...
%calcoliamo f e b_qp
    ...
    b_qp = [X_max - A_cal * x_attuale;
            ...
            U_max;
            -U_min;
            hx - Hx * A_cal_n * x_attuale];% spero che sia questo il vincolo terminale
